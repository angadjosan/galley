...
export const STARTERS: readonly DesignStarter[] = [
  {
    id: 'kit',
    label: 'Buttons',
    hint: 'One button, used four times',
    source: [
      '<design name="Buttons">',
      '  <define name="Button">',
      '    <box class="flex items-center justify-center h-40 px-4 bg-accent rounded-md hover:bg-accent-hover press:bg-accent-pressed">',
      '      <text name="slot:label" class="text-body font-semibold text-on-accent">Button</text>',
      '    </box>',
      '  </define>',
      '  <define name="Quiet button">',
      '    <box class="flex items-center justify-center h-40 px-4 bg-surface border border-border rounded-md hover:bg-raised">',
      '      <text name="slot:label" class="text-body text-fg">Button</text>',
      '    </box>',
      '  </define>',
      '  <frame name="Actions" width="390" class="flex flex-col gap-4 p-6 bg-canvas">',
      '    <text class="text-h2 text-fg">Actions</text>',
      '    <text class="text-small text-fg-muted">Every button here is the same button. Change the definition once.</text>',
      '    <use component="Button" label="Pay $42.00" />',
      '    <use component="Button" label="Save and continue" />',
      '    <box class="flex flex-row gap-3">',
      '      <use class="grow" component="Quiet button" label="Back" />',
      '      <use class="grow" component="Button" label="Next" />',
      '    </box>',
      '  </frame>',
      '</design>',
    ].join('\n'),
